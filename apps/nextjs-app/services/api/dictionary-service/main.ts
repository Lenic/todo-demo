import type { ICreatedSystemDictionaryItem, ISystemDictionaryItem } from './types';
...
import { ISystemDictionaryService } from './types';

@injectableWith(ISystemDictionaryService)
