...
export const CheckboxControl = <T extends ValidComponent = 'div'>(
  ...
  return (
    <>
      <CheckboxPrimitive.Input class="[&:focus-visible+div]:outline-none" />
      <CheckboxPrimitive.Control
        class={cn(
          'h-4 w-4 shrink-0 rounded-sm border border-primary shadow transition-shadow focus-visible:outline-none data-[disabled]:cursor-not-allowed data-[checked]:bg-primary data-[checked]:text-primary-foreground data-[disabled]:opacity-50',
          local.class,
        )}
        {...rest}
      >
